...
func TestExtractSlugAndPath(t *testing.T) {
	tests := []struct {
		name     string
		urlPath  string
		prefix   string
		...
		{
			name:     "list files",
			urlPath:  "/api/platform/sites/myforum/files",
			prefix:   "/api/platform/sites",
			wantSlug: "myforum",
			wantPath: "",
			wantOk:   true,
		},
		{
			name:     "single file",
			urlPath:  "/api/platform/sites/myforum/files/style.css",
			prefix:   "/api/platform/sites",
			wantSlug: "myforum",
			wantPath: "style.css",
			wantOk:   true,
		...
		{
			name:     "nested file",
			urlPath:  "/api/platform/sites/myforum/files/js/app.js",
			prefix:   "/api/platform/sites",
			wantSlug: "myforum",
			wantPath: "js/app.js",
			wantOk:   true,
		},
		{
			...
			urlPath:  "/api/platform/sites/myforum/upload",
			prefix:   "/api/platform/sites",
			wantSlug: "myforum",
			wantPath: "upload",
			wantOk:   true,
		...
		{
			name:     "reset endpoint",
			urlPath:  "/api/platform/sites/myforum/reset",
			prefix:   "/api/platform/sites",
			wantSlug: "myforum",
			wantPath: "reset",
			wantOk:   true,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			slug, filePath, ok := extractSlugAndPath(tt.urlPath, tt.prefix)
			if ok != tt.wantOk {
